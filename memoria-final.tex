...
1010 & Granada  & A-44 P.K. 118+300 sentido creciente (link A-44 P.K. 118+300 with A-92 P.K. 241+000) & 37.241668  & -3.6526 \\ \hline
...
1040 & Málaga  & A-7  P.K. 241+800, sentido decreciente (Link A-7 P.K. 241+800 with A-45 P.K. 142+400) &  36.757427 & -4.426879 \\ \hline
1050 & Málaga  & A-45 P.K. 121+700, sentido decreciente & 36.910454 & -4.444769 \\ \hline
1060 & Granada & A-92 P.K. 177+900, sentido decreciente (Link A-92 with A-92M) & 37.136209 & -4.282619 \\ \hline
\end{tabular}
}
...
Para ello se propuso el aumento del área de recolección de datos de tráfico para análisis y predicción (distintas ciudades y vías) colocándolos además cerca de fuentes de información conocidas. 


\subsection{Objetivo 2: Aumento de las fuentes de datos para obtención de datos más fiables} 
Se propuso usar otras fuentes, como los aforadores oficiales de la DGT o datos públicos, como Google Traffic y la mejora en el sistema de monitorización de los dispositivos a colocar (sensores wifi, NFC o BT) para mejorar la precisión. Podemos considerar este objetivo cubierto, ya que el haber añadido nuevas fuentes de datos, la captación de datos WiFi y su comparación con datos de espiras proporcionados por la DGT, los datos de monitorización y predicción han sido validados. ***MAS BONICO***
...
Durante el desarrollo del proyecto se han realizado varias publicaciones en revistas, que pueden consultarse en la sección \ref{subsec:publicacionesrevistas}.
...
Las publicaciones en congresos en el área de ingeniería informática y las ciencias de la computación también requieren
...
Aunque no se ha desarrollado aún ninguna patente, está en trámite el desarrollo de una patente para ***TERMINA***
...
La temática del proyecto fue utilizada en el ``H2020 Face2Face'' en el ICT Proposers Day 2015, organizado por ICT Proposers Day (ICT 2015 - Innovate, Connect, Transform) y la Red EEN (Lisboa, Portugal).
...
Se concurrió al Programa de Ayudas GENIL Para Realización De Actividades Por Grupos De Investigación Interdisciplinares (RAGII-2015) para formar el grupo interdisciplinar llamado ``Gestión de la movilidad en smart cities mediante técnicas de geomárketing''.
...
\ref{subsec:publicacionesrevistas}
