...
En esta subsección se describen los problemas encontrados durante la realización del proyecto.
Otros problemas surgidos durante el proyecto han venido dados principalmente por la naturaleza de los dispositivos de captación, al tener que estar colocados en zonas de difícil acceso. Estos problemas han sido resueltos utilizando distintas técnicas que se describen a continuación.
...
Se ha permitido identificar nuevos mercados/áreas de investigación (como el marketing y la monitorización de personas en lugares públicos), así como una mejora en la internacionalización del Grupo de Investigación (con una futura propuesta H20202) y la firma de contratos con empresas.
...
\subsubsection{Desarrollo en sistemas de tiempo real y dispositivos empotrados} El uso de la tarjeta Raspberry Pi ha supuesto una serie de mejoras en los conocimientos de Sistemas Operativos y programación concurrente.
\subsubsection{Análisis y predicción}
\subsubsection{}
