...
En estas publicaciones se ha descrito el sistema desarrollado \cite{GarciaSanchez15JCE}, así como la experimentación en predicción con datos recogidos \cite{Romero15ITISE,Castillo15ITISE,RIVAS15MAEB,Castillo15MAEB}.
...
Durante el desarrollo del proyecto distintas técnicas de Data Mining, Machine Learning, Cloud Computing y Optimización relacionadas con el proyecto han sido aplicadas a otros tipos de problemas. Las referencias \cite{BotsMAEB15,GarciaOrtega15MADEevostar,FernandezAres15BotsEvostar,FernandezAres15Cosecivi,GarciaSanchez15CIG} muestran distintas publicaciones relacionadas con la generación automática de IAs. También se han realizado distintos estudios relacionados con el Cloud Computing \cite{Garcia15ASOCO,Merelo15geccoCompanion,Merelo15Volunteer} o la comparativa de métodos de optimización \cite{Rico15IWANN} y la seguridad \cite{delasCuevas2015CC}. Todas las referencias anteriores cuentan con la mención al proyecto en los agradecimientos y han sido publicadas en conferencias nacionales e internacionales con revisión por pares, varias de ellas siendo publicadas en tres revistas con índice JCR en Q1 \cite{delasCuevas2015CC,Garcia15ASOCO,Merelo15Volunteer}.
...
Todas estas actividades han mejorado el posicionamiento de su Grupo de Investigación dentro de la red de socios internacionales y la mejora de la calidad y nivel tecnológico del grupo así como la colaboración con nuevos grupos de investigación internacionales.
...
En esta subsección se explican las distintas técnicas, metodologías y literatura relacionadas con la temática del proyecto, y como han sido usadas como base para el desarrollo del mismo, relacionando cada una con las distintas partes explicadas en esta memoria.
...
como datos personales. por lo que se requiere el consentimiento del usuario para que pueda almacenarse. Es por esta razón que nosotros hemos enmascarado las MAC de los dispositivos (como se explica en la sección \ref{subsec:proteccion}).
...
Corporate
 ...
 \item
J.-J. Merelo, M.~Garc\'ia-Valdez, P.~A. Castillo, P.~Garc\'ia-S\'anchez,
  P.~de~las Cuevas, N.~Rico, Volunteers in the clouds: A web based architecture
  to harness volunteer resources for low cost distributed evolutionary
  computation, IEEE Computational Intelligence Magazine. 
\end{itemize}
