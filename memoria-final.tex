...
Se proponen usar otras fuentes, como los aforadores oficiales de la DGT o datos públicos, como Google Traffic y la mejora en el sistema de monitorización de los dispositivos a colocar (sensores wifi, NFC o BT) para mejorar la precisión.

\subsection{Objetivo 3: Predicción del tráfico de forma más precisa}

, usando estas nuevas fuentes de datos, junto con un estudio de distintos métodos de predicción de series temporales.
